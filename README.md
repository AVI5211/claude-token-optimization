...
<p>
  <a href="https://github.com/AVI5211/claude-token-optimization"><img src="https://img.shields.io/badge/Rust-1.85%2B-orange?logo=rust" alt="Rust"></a>
...
```bash
# 1. Install
git clone https://github.com/AVI5211/claude-token-optimization.git
